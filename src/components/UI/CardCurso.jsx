  ...
  return (
    <div className="cc-card card border border-secondary-subtle shadow-sm h-100">
      ...
      <div className="cc-body">
        ...
        <div className="my-3">
          <a
            href={`https://wa.me/51900424018?text=${encodeURIComponent(`¡Hola! 👋 Me interesa inscribirme y obtener el descuento especial para el curso: ${curso.titulo || curso.title || 'este curso'}.`)}`}
            target="_blank"
