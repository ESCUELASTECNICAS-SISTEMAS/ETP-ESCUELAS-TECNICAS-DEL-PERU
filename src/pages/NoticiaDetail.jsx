...
export default function NoticiaDetail(){
  ...
  const dateText = noticia.published_at ? new Date(noticia.published_at).toLocaleString() : (noticia.fecha || noticia.publishedOn || '')
      ...
      <div className="container">
        ...
        {mediaUrl ? (
          <div className="mb-4 noticia-hero-wrapper">
            <img src={mediaUrl} alt={(media && (media.alt_text || media.alt)) || titleText} className="noticia-hero-img img-fluid rounded shadow-sm" />
            {(media && (media.caption || media.caption_text)) ? (
              <small className="text-muted d-block mt-2" dangerouslySetInnerHTML={{ __html: media.caption || media.caption_text }} />
            ) : null}
          </div>
        ) : null}
          ...
          <div className="col-12 col-lg-10 mx-auto">
            <div className="article-card p-4 mb-4">
              ...
              {(() => {
                ...
                return (
                  <>
                    {lead ? <div className="lead-paragraph mb-3" dangerouslySetInnerHTML={{ __html: '<p>'+lead+'</p>' }} /> : null}
                    <div className="article-content" dangerouslySetInnerHTML={{ __html: rest || contentHtml || '<p className="text-muted">No hay contenido disponible para esta noticia.</p>' }} />
                  </>
                )
              })()}
