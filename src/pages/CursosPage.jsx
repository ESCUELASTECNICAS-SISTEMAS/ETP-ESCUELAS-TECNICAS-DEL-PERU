...
export default function CursosPage(){
  ...
  return (
    ...
    <div className="page-container">
      ...
      <section className="page-hero bg-gradient-primary text-white py-5">

        <div className="container text-center">

          <h1 className="display-4 fw-bold mb-3">Cursos</h1>

          <p className="lead mb-0">Formación profesional de calidad</p>
